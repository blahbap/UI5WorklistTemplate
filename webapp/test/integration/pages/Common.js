sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/namespace/WorklistFromTemplate/app", ".html");
		...
		return Opa5.extend("com.namespace.WorklistFromTemplate.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/namespace/WorklistFromTemplate/localService/mockserver"], function (mockserver) {
